...
const MonthlyDonationTable = () => {
    ...
    const fetchDonations = async () => {
        try {
            const response = await axios.get('https://66e7cf09b17821a9d9da0963.mockapi.io/monthlyDonation');
    ...
    const handleDelete = async () => {
        if (selectedDonation) {
            try {
                await axios.delete(`https://66e7cf09b17821a9d9da0963.mockapi.io/monthlyDonation/${selectedDonation.id}`);
    ...
    return (
        <div className="read-container">
            ...
            />
            <h2 className="read-heading">Monthly Donations</h2>
