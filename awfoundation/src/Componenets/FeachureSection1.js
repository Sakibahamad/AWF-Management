...
import home2 from './Home.jpg'; // Image for the top-right corner
import home from './Home.png'; // Image for the top-right corner
...
const FeatureSection1 = () => {
  ...
  const handleHomeClick = () => {
    navigate('/sign-out'); // Navigate to /sign-out when the Home image is clicked
  };
