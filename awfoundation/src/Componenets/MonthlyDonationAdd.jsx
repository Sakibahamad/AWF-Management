...
import './MonthlyDonationAdd.css';

initializeIcons();

const MonthlyDonationAdd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('https://66e7cf09b17821a9d9da0963.mockapi.io/monthlyDonation', {
    ...
    return (
        <div className="create-donation-form-container">
            <div className="create-donation-form-wrapper">
                <h2 className="create-donation-form-heading">Add Monthly Donation</h2>
            ...
            >
                <div className="modal-content">
                    <h3>Success</h3>
                    <p>Monthly donation has been successfully added.</p>
...
export default MonthlyDonationAdd;
