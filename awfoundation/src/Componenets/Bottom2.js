...
import './bottomSection1.css';
import Home from './Home.jpg'; // Import your Home image

const Bottom2 = () => {
  const navigate = useNavigate(); // Initialize useNavigate for programmatic navigation

  const handleHomeClick = () => {
    navigate('/homepage'); // Navigate to /sign-out when Home image is clicked
  };
